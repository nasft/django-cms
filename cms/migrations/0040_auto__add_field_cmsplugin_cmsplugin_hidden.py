...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CMSPlugin.cmsplugin_hidden'
        db.add_column(u'cms_cmsplugin', 'cmsplugin_hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CMSPlugin.cmsplugin_hidden'
        db.delete_column(u'cms_cmsplugin', 'cmsplugin_hidden')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'cmsplugin_hidden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
